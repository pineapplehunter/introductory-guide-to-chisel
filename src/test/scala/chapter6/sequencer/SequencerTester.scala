...
//    ))
//
//    test(new SimDTMSequencer(p)(limit)).runPeekPoke(c => new SequencerUnitTester(c) {
//      idleTest()
//      step(5)
//    })
//  }
...
//    ))
//
//    test(new SimDTMSequencer(p)(limit)).runPeekPoke(c =>
...
//    ))
//
//    test(new SimDTMSequencer(p)(limit)).runPeekPoke {
//      c =>
//        new SequencerUnitTester(c) {
...
//    val r = new Random(1)
//
//    test(new SimDTMSequencer(p)(limit * 10)).runPeekPoke(
//      c =>
//        new SequencerUnitTester(c) {
//
//          for (_ <- 0 until 10) {
